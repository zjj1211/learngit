       ...
       <div class="container-fluid">
         <div class="row">
           <div class="col-sm-3 col-md-2 sidebar well">
             <ul class="nav nav-sidebar">
               ...
               <li class="active"><a href="FrontManage.asp"><span class="glyphicon glyphicon-folder-open"></span> 前台管理</a></li>
         ...
         <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 well wrapper">
            <div class="panel panel-primary">
                <div class="panel-heading">前台管理
                  <!-- <div class="pull-right btn-rectify"><button class="btn btn-success btn-sm" data-toggle="modal" data-target="#detail">增加</button></div> -->
                  <div class="pull-right btn-rectify"><a class="btn btn-success btn-sm" href="NewsAdd.asp?newsId=0!a">增加</a></div>
...
Set rs=Server.CreateObject("ADODB.Recordset")
  ...
  '设置游标类型
  rs.CursorType = 3
rs.open"select Id,Title,PostTime from dbo.article order by Id desc"
...
%>                        
                        <li><a href="NewsAdd.asp?newsId=<%=rs.Fields(0).value%>!a" class="clickDetail" id="articleDetail"><%=rs.Fields(1).value%></a><p class="hidden" name="newsId"><%=rs.Fields(0).value%></p><!-- <button class="btn btn-success btn-xs pull-right edit">修改</button> --><p class="pull-right"><%=rs.Fields(2).value%></p><button class="btn btn-danger btn-xs deleteArticle">删除</button></li>
<%
rs.movenext
...
%>                       
                  ...
                  <div class="bottomNav">
                    ...
                    response.Write("<li><a href=FrontManage.asp?page=1>第一页</a></li>")
                    end if 
                    '设置"上一页"链接
                    if page=1 then 
                    response.Write("<li><a href=""#"">上一页</a></li>")
                    else
                    response.Write("<li><a href=FrontManage.asp?page="&page-1&">上一页</a></li>")
                    end if 
                    ...
                    response.Write("<li><a href=FrontManage.asp?page="&page+1&">下一页</a></li>")
                    end if 
                    '设置"最后一页"链接
                    if page=rs.pagecount then 
                    response.write("<li><a href=""#"">最后一页</a></li>")
                    else
                    response.Write("<li><a href=FrontManage.asp?page="&rs.pagecount&">最后一页</a></li>")
                    end if 
                    conn.close
                    ...
                    Set conn=nothing
                    %>
                    <!-- <li><a class="inputrectify"><input type="text" class="form-control jumpto"></a>页<button class="btn btn-info">跳转</button></li> -->
                  </ul>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form role="form" class="form-horizontal" id="postArticle">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <textarea class="form-control" rows="5" name="articleContent"></textarea>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2">发布者</label>
                              <div class="col-sm-4">
                                <input type="text" class="form-control" name="articlePoster">
                              </div>
                            </div>
                          </form>
                        </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                          <button type="button" class="btn btn-primary" id="updateArticle">保存更改</button>
                        </div>
                      </div>
                    </div>                    
                  </div>
